...
if __name__ == '__main__':
    ...
    #Test1: Inserting ObjectListItem to DB with no testObj
    ...
    #Test1: Adding TestMutable instance to ObjectListItem instance.
    print("create testM")
    testM=TestMutable()
    ...
    #Test2: Changing data of TestMutable instance, but SQLAlchemy cannot understand it.
